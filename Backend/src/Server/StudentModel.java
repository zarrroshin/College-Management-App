...
public class StudentModel {
    private static final String FILE_PATH = "C:\\Users\\Lenovo\\OneDrive\\deks\\AP_PROJECT\\College-Management-App\\Backend\\data\\student.txt";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(FILE_PATH))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (student_detail.length >= 3)
                    this.students.add(student_detail);
            }
        } catch (IOException e) {
